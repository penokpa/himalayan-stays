...
function NavLink({
  ...
  return (
    <Link
      href={href}
      className="flex items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium text-gray-700 transition-colors hover:bg-gray-100 hover:text-gray-900 dark:text-stone-300 dark:hover:bg-stone-800 dark:hover:text-stone-100"
    >
      {icon}
...
export default function OwnerLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="flex min-h-screen bg-gray-50 dark:bg-stone-950">
      <aside className="sticky top-0 flex h-screen w-16 flex-col border-r border-gray-200 bg-white md:w-60 dark:border-stone-800 dark:bg-stone-900">
        <div className="flex h-16 items-center border-b border-gray-200 px-4 dark:border-stone-800">
          <Link href="/owner" className="flex items-center gap-2">
            ...
            <span className="hidden text-sm font-semibold text-gray-900 md:block dark:text-stone-100">
              Lodge Owner
            </span>
          </Link>
        </div>
        ...
        <nav className="flex flex-1 flex-col gap-1 p-3">
          ...
          <NavLink
            ...
            icon={
              <svg className="h-5 w-5 shrink-0" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 12 12 3l9.75 9M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75" />
              </svg>
            }
          />
          <NavLink
